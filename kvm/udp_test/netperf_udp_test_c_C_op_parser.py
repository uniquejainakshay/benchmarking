...
#  66 = 8 ( udp header ) + 20 ( ip header ) + (38 l1 and l0 ethernet headers ) 
	ans.append([pkt_size, b[i][5], b[i][6], b[i+1][3], b[i+1][4], 1000.0*(pkt_size-42)/(pkt_size-42+66), 1000.0 * ( float(b[i][5]) / float(pkt_size)), 1000.0 * (float(b[i+1][3]) / float(pkt_size + 24))])
